...
/*!
   ...
   This path is normally shared so that an x2go or FreeNX connection can use it. This 
   way, files that are generated by the server in the concrete path will be opened in
